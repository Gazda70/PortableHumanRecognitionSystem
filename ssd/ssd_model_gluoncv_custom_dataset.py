...
PATH_TO_DATASET='E:\PortableHumanRecognitionSystem\PortableHumanRecognitionSystem\datasets\myDataset\GluonLikeVOC'
...
train_dataset = VOCLike(root=PATH_TO_DATASET, splits=((2021, 'train'),))
